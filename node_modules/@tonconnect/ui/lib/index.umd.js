...
(function(global2, factory) {
 ...
 keypair secretkey: ${this.keyPair.secretKey.toString()}`);
  ...
  function getWebPageManifest() {
    var _a2;
    const origin = (_a2 = getWindow$1()) === null || _a2 === void 0 ? void 0 : _a2.location.origin;
    if (origin) {
  ...
  const notifications$1 = {
    confirm: {
      header: "Confirm action in\xA0your wallet"
    },
    transactionSent: {
      header: "Transaction sent",
      text: "Your transaction has been sent to\xA0the\xA0network and\xA0will be\xA0processed in\xA0a\xA0few seconds."
    },
    transactionCanceled: {
      header: "Action cancelled",
      text: "The\xA0action was canceled because there\xA0were no\xA0expected changes in\xA0the\xA0blockchain."
    }
  };
  const walletModal$1 = {
    ...
    selectWalletModal: {
      ...
      selectWallet: "Choose your preferred wallet from the\xA0options to\xA0get\xA0started.",
      learnMore: "Learn more"
    },
    qrCodeModal: {
      connectWith: "Connect with {{ name }}",
      scan: "Scan QR\xA0code with your phone\u2019s or\xA0{{ name }}\u2019s\xA0camera.",
  ...
  const actionModal$1 = {
    confirmTransaction: {
      header: "Confirm action in\xA0your\xA0wallet",
      text: "Checking after confirmation usually takes\xA0some time."
    },
  ...
  const notifications = {
    confirm: {
      header: "\u041F\u043E\u0434\u0442\u0432\u0435\u0440\u0434\u0438\u0442\u0435 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u0432\xA0\u0441\u0432\u043E\u0451\u043C \u043A\u043E\u0448\u0435\u043B\u044C\u043A\u0435"
    },
    transactionSent: {
      header: "\u0422\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u044F \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430",
      text: "\u0412\u0430\u0448\u0430 \u0442\u0440\u0430\u043D\u0437\u0430\u043A\u0446\u0438\u044F \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430 \u0432\xA0\u0441\u0435\u0442\u044C \u0438\xA0\u0431\u0443\u0434\u0435\u0442 \u043E\u0431\u0440\u0430\u0431\u043E\u0442\u0430\u043D\u0430 \u0447\u0435\u0440\u0435\u0437\xA0\u043D\u0435\u0441\u043A\u043E\u043B\u044C\u043A\u043E \u0441\u0435\u043A\u0443\u043D\u0434."
    },
    transactionCanceled: {
      header: "\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043E\u0442\u043C\u0435\u043D\u0435\u043D\u043E",
      text: "\u0414\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u043F\u0440\u0435\u0440\u0432\u0430\u043D\u043E \u043F\u043E\u0442\u043E\u043C\u0443 \u0447\u0442\u043E \u0432\xA0\u0431\u043B\u043E\u043A\u0447\u0435\u0439\u043D\u0435 \u043D\u0435\u0442\xA0\u043E\u0436\u0438\u0434\u0430\u0435\u043C\u044B\u0445 \u0438\u0437\u043C\u0435\u043D\u0435\u043D\u0438\u0439."
    }
  };
  const walletModal = {
    ...
    qrCodeModal: {
      ...
      scan: "\u041E\u0442\u0441\u043A\u0430\u043D\u0438\u0440\u0443\u0439\u0442\u0435 QR-\u043A\u043E\u0434 \u043A\u0430\u043C\u0435\u0440\u043E\u0439 \u0442\u0435\u043B\u0435\u0444\u043E\u043D\u0430 \u0438\u043B\u0438\xA0\u043F\u0440\u0438\u043B\u043E\u0436\u0435\u043D\u0438\u044F\xA0{{ name }}.",
...
`;
  ...
  function applyWalletsListConfiguration(walletsList, configuration) {
    ...
    const filteredWalletsList = ((_a2 = configuration.excludeWallets) == null ? void 0 : _a2.length) ? walletsList.filter(
      (wallet) => {
        var _a3;
        return (_a3 = configuration.excludeWallets) == null ? void 0 : _a3.every((item) => item !== wallet.name);
      }
    ) : walletsList;
  ...
  const WalletsModal = () => {
    ...
    const [fetchedAdditionalRequest, {
      ...
      var _a2;
      if (refetching) {
        return (_a2 = appState.getConnectParameters) == null ? void 0 : _a2.call(appState);
      }
      return void 0;
    });
